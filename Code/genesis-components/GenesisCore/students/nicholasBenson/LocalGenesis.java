...
public class LocalGenesis extends Genesis {
	...
	public LocalGenesis() {
		...
		// This one connects language processor output to your local processor via the local processor's default port

		Connections.wire(Markers.NEXT, GenesisGetters.getAnaphoraExpert(), getLocalProcessor());
		...
		Connections
		        .wire(StoryProcessor.STORY_PROCESSOR_SNAPSHOT, getMentalModel1().getStoryProcessor(), StoryProcessor.STORY_PROCESSOR_SNAPSHOT, getLocalProcessor());
	}
