 ...
 * @author Kevin
 *
 *The Automated UI class takes an AutomatedPanel
 *and equips with a text box that allows the user to make
 *queries about the accompanying lattice.
 */
public class AutomatedUI extends JFrame {
    ...
    /**
     * 
     * @param latticePanel, the lattice panel containing the lattice for the title
     * @param title, the name of this window, normally the verb
     */
        ...
        questionField.addKeyListener(new KeyListener(){
            ...
            public void keyTyped(KeyEvent arg0) {
                if(KeyEvent.getKeyText(arg0.getKeyChar()).equalsIgnoreCase("Enter")){
                    ...
                    String answer = "";
                    try {
                        answer = AutomatedLearner.answerQuestion(question, lp);
                    } catch (Exception e) {
