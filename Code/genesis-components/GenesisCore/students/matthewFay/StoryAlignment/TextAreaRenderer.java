...
public class TextAreaRenderer extends JTextArea implements TableCellRenderer { 
    ...
    public TextAreaRenderer() { 
        ...
        colorHash = new HashMap<Integer, HashMap<Integer,Color>>();
    } 
    
    public HashMap<Integer, HashMap<Integer, Color>> colorHash;
    public void setColor(int row, int column, Color color) {
    	if(colorHash.get(row) == null)
    		colorHash.put(row, new HashMap<Integer, Color>());
    	if(colorHash.get(row).get(column) != null)
    		colorHash.get(row).remove(column);
    	colorHash.get(row).put(column, color);
    }
    public Color getColor(int row, int column) {
    	Color color = Color.WHITE;
    	if(colorHash.get(row) == null)
    		return color;
    	color = colorHash.get(row).get(column);
    	if(color == null)
    		color = Color.WHITE;
    	return color;
    }
