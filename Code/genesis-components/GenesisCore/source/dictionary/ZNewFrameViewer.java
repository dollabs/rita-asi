 ...
 */
public class ZNewFrameViewer extends NegatableJPanel {
	Ports ports;

	ZFrameViewer fv = new ZFrameViewer();

	Entity input = null;

	public ZNewFrameViewer() {
	...
	public void view(Object signal) {
		...
		setTruthValue(this.fv.getBodyPanel(), signal);
	}
	
	public void setTruthValue(NegatableJPanel panel, Object object) {
		// Mark.a(object);
	...
	public static void main(String[] ignore) {
		...
		ZNewFrameViewer view = new ZNewFrameViewer();
