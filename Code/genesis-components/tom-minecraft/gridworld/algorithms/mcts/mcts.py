...
class MonteCarloAgent(object):
    def __init__(self, environment, best_child_policy=UCBPolicy, **kwargs):
        ...
        self._runtime = datetime.timedelta(seconds=kwargs.get('runtime', 0.05))
        self._max_depth = kwargs.get('max_depth', 20)
    ...
    def pick_move_policy(self, env):
        ...
        return choice(env.available_actions()) #list(range(env.nActions())))
