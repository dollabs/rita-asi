...
HEIGHT = 30 ## height of observer agent
DISCRETIZED = True
...
def replay(trajectory=None):
    ...
    def should_attack(ob):
        if 'LineOfSight' in ob:
            ...
            # print(dist)
            if dist < 4 and (look_at == 'dark_oak_door' or look_at == 'chest' or look_at == 'dirt' or look_at == 'ender_chest'):
                return True
        return False
            ...
            while world_state.is_mission_running:
                ...
                if world_state.number_of_observations_since_last_state > 0:
                    ...
                    if DISCRETIZED:
                        ...
                        ah.sendCommand("turn "+str(yaw_diff/90))
                    ...
                    if yaw >= 315 or yaw < 45:
                        ...
                        if DISCRETIZED:
                            ...
                            ah.sendCommand("move "+str(x - x_p))
                            ah.sendCommand("strafe "+str(z - z_p))

                    elif yaw >= 45 or yaw < 135:
                        ...
                        if DISCRETIZED:
                            ...
                            ah.sendCommand("move "+str(z_p - z))
                            ah.sendCommand("strafe "+str(x - x_p))

                    elif yaw >= 135 or yaw < 225:
                        ...
                        if DISCRETIZED:
                            ...
                            ah.sendCommand("move "+str(x_p - x))
                            ah.sendCommand("strafe "+str(z_p - z))

                    elif yaw >= 225 or yaw < 315:
                        ...
                        if DISCRETIZED:
                            ...
                            ah.sendCommand("move "+str(z - z_p))
                            ah.sendCommand("strafe "+str(x_p - x))
