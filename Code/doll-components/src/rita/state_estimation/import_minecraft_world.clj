...
(defn generate-fixups
  []
  ;; Add patient at -2144 52 149 +++
  (generate-data :prismarine -2144 52 149)
  ;; Add chairs at -2145 52 150, -2147 52 150, -2149 52 150 +++
  (generate-data  :cauldron -2145 52 150)
  (generate-data  :cauldron -2147 52 150)
  (generate-data  :cauldron -2149 52 150)
  (doseq [x (range -2154 -2151)]
    (doseq [y (range 52 55)]
      (generate-data :stained_hardened_clay x y 149)
      (generate-data :stained_hardened_clay x y 150)))
  (doseq [x (range -2160 -2157)]
    (doseq [y (range 52 55)]
      (generate-data :stained_hardened_clay x y 149)
      (generate-data :stained_hardened_clay x y 150)))
  (doseq [x (range -2164 -2143)]
    (doseq [y (range 52 55)]
      (generate-data :stained_hardened_clay x y 143)
      (generate-data :stained_hardened_clay x y 148)))
  (doseq [z (range 144 151)]
    (doseq [y (range 52 55)]
      (generate-data :stained_hardened_clay -2143 y z)))
  (doseq [y (range 52 55)]
    ;; Add level at -215753 149 +++
    (generate-data :wooden_door -2162 y 148)
    (generate-data :wooden_door -2156 y 148)
    (generate-data :wooden_door -2147 y 148)))

(defn temporary-fixup
  [world mca]
  ;; Add patient at -2144 52 149 +++
  (world-set world mca :prismarine -2144 52 149)
  ;; Add chairs at -2145 52 150, -2147 52 150, -2149 52 150 +++
  (world-set world mca  :cauldron -2145 52 150)
  (world-set world mca  :cauldron -2147 52 150)
  (world-set world mca  :cauldron -2149 52 150)
  (doseq [x (range -2154 -2151)]
    (doseq [y (range 52 55)]
      (world-set world mca :stained_hardened_clay x y 149)
      (world-set world mca :stained_hardened_clay x y 150)))
  (doseq [x (range -2160 -2157)]
    (doseq [y (range 52 55)]
      (world-set world mca :stained_hardened_clay x y 149)
      (world-set world mca :stained_hardened_clay x y 150)))
  (doseq [x (range -2164 -2143)]
    (doseq [y (range 52 55)]
      (world-set world mca :stained_hardened_clay x y 143)
      (world-set world mca :stained_hardened_clay x y 148)))
  (doseq [z (range 144 151)]
    (doseq [y (range 52 55)]
      (world-set world mca :stained_hardened_clay -2143 y z)))
  (doseq [y (range 52 55)]
    ;; Add level at -215753 149 +++
    (world-set world mca :wooden_door -2162 y 148)
    (world-set world mca :wooden_door -2156 y 148)
    (world-set world mca :wooden_door -2147 y 148)))
